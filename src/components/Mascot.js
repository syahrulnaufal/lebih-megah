      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          >
            ...
            {/* Video Container */}
            <div className="relative group rounded-[2.5rem] overflow-hidden border border-[#5cb3ff]/10 glass-navy shadow-[0_0_50px_rgba(92,179,255,0.15)] max-w-sm w-full aspect-square flex items-center justify-center p-2">
              <video
                src="/images/mas.mp4"
                autoPlay
                loop
              ...
              <div className="absolute -bottom-6 -right-6 w-28 h-28 md:w-36 md:h-36 rounded-3xl overflow-hidden glass-navy border border-[#5cb3ff]/10 p-2 shadow-2xl animate-float">
                <img
                  src="/images/mass.png"
                  alt="Tivo PNG"
          ...
          >
            ...
            <h2 className="font-bold text-4xl md:text-6xl text-white font-jakarta leading-none">
              Kenalkan, <span className="text-[#5cb3ff]">TIVO!</span>
            </h2>

            {/* Dialogue Bubble */}
            <div className="relative glass-navy border border-[#5cb3ff]/10 p-6 rounded-[2.5rem] rounded-tl-none shadow-xl max-w-xl transition-all duration-300 min-h-[100px] flex items-center">
            ...
            <button
              ...
              className="flex items-center gap-2 px-6 py-3 rounded-full bg-white/5 border border-[#5cb3ff]/15 hover:border-neon-blue/50 hover:bg-neon-blue/10 text-white font-bold text-sm transition-all duration-300 font-jakarta uppercase tracking-wider"
            >
