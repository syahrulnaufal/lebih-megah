...
const metrics = [
  ...
  },
  {
    ...
    color: 'var(--color-highlight-lime)', // Magenta
  },
];
...
const ImpactProjection = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/2 left-1/4 -translate-y-1/2 w-[600px] h-[600px] bg-[var(--color-highlight-lime)]/5 rounded-full blur-[120px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          <h2 className="font-bold text-3xl md:text-6xl mb-6 font-jakarta">
            ...
            <span className="text-[var(--color-highlight-lime)]">PROJECTION</span>
          </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {metrics.map((item, idx) => {
            ...
            return (
              <div
                key={idx}
                className={`group relative flex flex-col p-8 md:p-10 rounded-[2.5rem] glass-navy border border-[var(--color-highlight-lime)]/10 transition-all duration-700 shadow-xl hover:border-[var(--color-highlight-lime)]/30 hover:scale-[1.02] ${
        ...
        <div
          className={`glass-navy border border-[var(--color-highlight-lime)]/10 p-8 md:p-10 rounded-[2.5rem] max-w-4xl mx-auto shadow-2xl relative overflow-hidden transition-all duration-700 delay-300 ${
            visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
          }`}
        >
